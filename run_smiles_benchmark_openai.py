#!/usr/bin/env python3
"""Run the benchmark against an OpenAI model with no tools.
...
def _openai_text_response(response) -> str:
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model", default=_DEFAULT_MODEL, help="OpenAI model name")
...
def main() -> None:
    ...
    raw1 = _openai_text_response(response1)
